...
declare type Props<LinkOptions extends Record<string, unknown>> = Omit<default_2.ButtonHTMLAttributes<HTMLButtonElement>, keyof CustomProps<LinkOptions>> & CustomProps<LinkOptions>;
